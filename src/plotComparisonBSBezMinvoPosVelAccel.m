...
figure; subplot(3,3,1);hold on;title('Position');xlabel('x'); ylabel('y'); zlabel('z') %set(gcf, 'Position',  [500, 500, 3000, 2000])
...
A=getSolutionA(2,"01");
area_minvo= plot_plane_convex_hull(v_x, v_y, v_z, A, 'g', 0.2);
...
deltaT=1/7;
knots = [0     0     0     0  deltaT 2*deltaT 3*deltaT 4*deltaT 5*deltaT 6*deltaT   7*deltaT     7*deltaT    7*deltaT   7*deltaT];  % knot vector
...
area_bs= plot_plane_convex_hull(v_x, v_y, v_z, A, 'y', 0.2);
fplot3(v_x'*T2,v_y'*T2,v_z'*T2,interv,'r','LineWidth',3);
...
subplot(3,3,1);hold on; view(view_pos)
plot3(points_x,points_y,points_z,'-b'); plot_arrow_axes(length_pos)
subplot(3,3,2);hold on; view(view_vel)
plot3(points_v_x,points_v_y,points_v_z,'-b'); plot_arrow_axes(length_vel)
subplot(3,3,3);hold on; view(view_accel)
plot3(points_a_x,points_a_y,points_a_z,'-b'); plot_arrow_axes(length_accel)


subplot(3,3,4);hold on; view(view_pos)
plot3(points_x,points_y,points_z,'-b'); plot_arrow_axes(length_pos)
subplot(3,3,5);hold on; view(view_vel)
plot3(points_v_x,points_v_y,points_v_z,'-b'); plot_arrow_axes(length_vel)
subplot(3,3,6);hold on; view(view_accel)
plot3(points_a_x,points_a_y,points_a_z,'-b'); plot_arrow_axes(length_accel)


subplot(3,3,7);hold on; view(view_pos)
plot3(points_x,points_y,points_z,'-b'); plot_arrow_axes(length_pos)
subplot(3,3,8);hold on; view(view_vel)
plot3(points_v_x,points_v_y,points_v_z,'-b'); plot_arrow_axes(length_vel)
subplot(3,3,9);hold on; view(view_accel)
plot3(points_a_x,points_a_y,points_a_z,'-b'); plot_arrow_axes(length_accel)
...
% plot(t_min:increm:t_max,points_x)
% fplot(t,pol_x'*T3, [0,1],'r')
% 
% subplot(1,2,2); hold on;
% fplot(t,v_x'*T2, [0,1],'r')
