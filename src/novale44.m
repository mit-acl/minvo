...
% settings=sdpsettings('moment.order',4,'savesolveroutput',1,'savesolverinput',1,'solver','moment','showprogress',1,'verbose',2,'debug',1); %,'ipopt.tol',1e-10 %'moment.solver','mosek',
...
%settings=sdpsettings('sparsepop.relaxOrder',3,'usex0',0,'savesolveroutput',0,'savesolverinput',1,'solver','sparsepop','showprogress',1,'verbose',2,'debug',1,'fmincon.maxfunevals',300000,'fmincon.MaxIter', 300000);
settings=sdpsettings('usex0',1,'savesolveroutput',1,'savesolverinput',1,'solver','kktqp','showprogress',1,'verbose',2,'debug',1); %,'ipopt.tol',1e-10 %'moment.solver','mosek',
