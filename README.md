...
Given a matrix <img src="https://render.githubusercontent.com/render/math?math=\boldsymbol{P}"> that, in each row <img src="https://render.githubusercontent.com/render/math?math=i">, contains the coefficients (in decreasing order) of the <img src="https://render.githubusercontent.com/render/math?math=i">-th coordinate of the given <img src="https://render.githubusercontent.com/render/math?math=n">-th order polynomial curve <img src="https://render.githubusercontent.com/render/math?math=\boldsymbol{p}(t), "> <img src="https://render.githubusercontent.com/render/math?math=t\in[-1,1]">, you can obtain the smallest <img src="https://render.githubusercontent.com/render/math?math=n">-simplex that contains that curve by running this:
